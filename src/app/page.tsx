...
import { ArrowUpRight, Code2, Database, Github, Linkedin, Server, Wrench } from 'lucide-react'
...
export default function Home() {
  return (
    <main className="mx-auto min-h-screen max-w-screen-xl px-6 py-12 md:px-12 md:py-10 lg:px-24 lg:pt-0 lg:pb-10">
              ...
              <ul className="mt-16 w-max">
                <li>
                  <a className="group active flex items-center py-3" href="#about">
                    ...
                    <span className="nav-text text-xs font-bold tracking-widest text-slate-500 uppercase group-hover:text-slate-200 group-focus-visible:text-slate-200">À propos</span>
                  </a>
                </li>
                <li>
                  <a className="group flex items-center py-3" href="#experience">
                    <span className="nav-indicator mr-4 h-px w-8 bg-slate-600 transition-all group-hover:w-16 group-hover:bg-teal-400 motion-reduce:transition-none"></span>
                    <span className="nav-text text-xs font-bold tracking-widest text-slate-500 uppercase group-hover:text-slate-200 group-focus-visible:text-slate-200">Expérience</span>
                  </a>
                </li>
                <li>
                  <a className="group flex items-center py-3" href="#skills">
                    <span className="nav-indicator mr-4 h-px w-8 bg-slate-600 transition-all group-hover:w-16 group-hover:bg-teal-400 motion-reduce:transition-none"></span>
                    <span className="nav-text text-xs font-bold tracking-widest text-slate-500 uppercase group-hover:text-slate-200 group-focus-visible:text-slate-200">Compétences</span>
                  </a>
                </li>
                <li>
                  <a className="group flex items-center py-3" href="#contact">
                    <span className="nav-indicator mr-4 h-px w-8 bg-slate-600 transition-all group-hover:w-16 group-hover:bg-teal-400 motion-reduce:transition-none"></span>
                    <span className="nav-text text-xs font-bold tracking-widest text-slate-500 uppercase group-hover:text-slate-200 group-focus-visible:text-slate-200">Contact</span>
                  </a>
                </li>
              </ul>
            </nav>
          ...
          <section id="about" className="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24" aria-label="À propos">
            ...
            <div className="space-y-4 text-slate-400">
              <p className="pb-10 leading-relaxed">
                <strong className="font-medium text-slate-200">Fort de plus de 10 ans d'expérience hands-on</strong>, j'allie développement web et culture DevOps à la gestion d'équipes techniques.
                Toujours à l'affût des innovations, je m'attache à aligner la technologie sur vos objectifs business pour bâtir des solutions efficaces et pérennes.
              </p>
              <p className="pb-10">
                Mon approche repose sur une <strong className="font-medium text-slate-200">compréhension fine entre les objectifs business et les besoins techniques</strong>. Autodidacte et rigoureux,
                je gère l'intégralité des outils techniques d'une entreprise, de l'infrastructure Cloud au parc informatique.
              </p>
              <div>
                <h3 className="mb-2 font-semibold text-slate-200">Mes atouts clés :</h3>
                  ...
                  <div className="z-10 sm:col-span-6">
                    <h3 className="leading-snug font-medium text-slate-200">
                      <div>
                        ...
                        <span className="group/link relative inline-flex items-baseline text-base leading-tight font-medium text-slate-200 hover:text-teal-300 focus-visible:text-teal-300">
                          CTO (Directeur technique) - Emprunte Mon Toutou
                        </span>
                      </div>
                    </h3>
                    ...
                    <ul className="relative mt-2 flex flex-wrap" aria-label="Technologies utilisées">
                      ...
                      <li className="mt-2 mr-1.5">
                        <div className="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs leading-5 font-medium text-teal-300">App Mobile / Web</div>
                      </li>
                      <li className="mt-2 mr-1.5">
                        <div className="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs leading-5 font-medium text-teal-300">DevOps</div>
                      </li>
                      <li className="mt-2 mr-1.5">
                        <div className="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs leading-5 font-medium text-teal-300">Vue.js / Next.js</div>
                      </li>
                      <li className="mt-2 mr-1.5">
                        <div className="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs leading-5 font-medium text-teal-300">DPO</div>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <li className="mb-12">
                <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:group-hover/list:opacity-50 lg:hover:!opacity-100">
                  ...
                  <div className="z-10 sm:col-span-6">
                    ...
                    <div className="relative mt-2 space-y-2 text-sm leading-normal text-slate-400">
                    ...
                    <ul className="relative mt-2 flex flex-wrap" aria-label="Technologies utilisées">
                      ...
                      <li className="mt-2 mr-1.5">
                        <div className="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs leading-5 font-medium text-teal-300">Prestashop</div>
                      </li>
                      <li className="mt-2 mr-1.5">
                        <div className="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs leading-5 font-medium text-teal-300">DevOps</div>
                      </li>
                ...
                <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:group-hover/list:opacity-50 lg:hover:!opacity-100">
                  ...
                  <div className="z-10 sm:col-span-6">
                    ...
                    <ul className="relative mt-2 flex flex-wrap" aria-label="Technologies utilisées">
                      ...
                      <li className="mt-2 mr-1.5">
                        <div className="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs leading-5 font-medium text-teal-300">Support IT</div>
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:group-hover/list:opacity-50 lg:hover:!opacity-100">
                  ...
                  <div className="z-10 sm:col-span-6">
                    <h3 className="leading-snug font-medium text-slate-200">
                      <div>
                        <span className="absolute -inset-x-4 -inset-y-4 hidden rounded-md transition motion-reduce:transition-none lg:-inset-x-6 lg:block lg:group-hover:bg-slate-800/50 lg:group-hover:shadow-[inset_0_1px_0_0_rgba(148,163,184,0.1)] lg:group-hover:drop-shadow-lg"></span>
                        <span className="relative inline-flex items-baseline text-base leading-tight font-medium text-slate-200">Expériences précédentes</span>
                      </div>
                    </h3>
                    <div className="relative mt-2 space-y-3 text-sm leading-normal text-slate-400">
                      <div>
